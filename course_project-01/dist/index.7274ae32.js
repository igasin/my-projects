...
n.forEach(e=>{e.addEventListener("click",c)}),$(function(){$(document).scroll(function(){var e=$("header"),o=$(".wrapper-nav");e.toggleClass("scrolled",$(this).scrollTop()>e.height()),o.toggleClass("scrolled-border",$(this).scrollTop()>e.height())})}),new Swiper(".swiper",{direction:"horizontal",loop:!0,pagination:{el:".swiper-pagination",clickable:!0},// скролл мышью
// mousewheel: {
// 	sensitivity: 1,
// 	eventsTarget: ".swiper"
// },
